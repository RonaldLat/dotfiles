...
config.bind('<space>yd', 'hint links spawn st -e youtube-dl {hint-url}')
config.bind('<space>yp', 'hint links spawn  mpv {hint-url}')
...
config.bind('<Alt-Shift-u>', 'spawn --userscript qute-keepassxc --key 6703057CC4E82806E3D1002FAC892382B987709A', mode='insert')
config.bind('pw', 'spawn --userscript qute-keepassxc --key 6703057CC4E82806E3D1002FAC892382B987709A', mode='normal')
